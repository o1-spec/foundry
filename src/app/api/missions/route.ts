...
export async function POST(request: NextRequest) {
  try {
    ...
    const DEFAULT_AGENTS = [
      { name: "Planner Agent",    role: "Planner",         model: process.env.BTL_CHEAP_MODEL  || "gpt-4o-mini" },
      ...
      { name: "QA Agent",         role: "QA Specialist",   model: process.env.BTL_CHEAP_MODEL  || "gpt-4o-mini" },
      { name: "Reviewer Agent",   role: "Lead Reviewer",   model: process.env.BTL_CHEAP_MODEL  || "gpt-4o-mini" },
    ];
